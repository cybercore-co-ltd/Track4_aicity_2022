_base_ = [
    '../../mmdet/tridentnet/tridentnet_r50_caffe_mstrain_3x_coco.py',
]
load_from = "https://download.openmmlab.com/mmdetection/v2.0/tridentnet/tridentnet_r50_caffe_mstrain_3x_coco/tridentnet_r50_caffe_mstrain_3x_coco_20201130_100539-46d227ba.pth"
cudnn_benchmark = False
find_unused_parameters = True

# dataset
# img_norm_cfg = dict(
#     mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)img_norm_cfg = dict(
